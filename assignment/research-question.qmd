...
:::{.callout-important}
Due September 27 at 11:59 pm on Canvas
:::
...
1. Discuss a topic in the fielf of political psychology.
2. List at least five peer-reviewed journal articles using the full citation in **APA** or **APSA** style (only use one for consistency). 
3. Double check the citations. Do not simply rely on an online generator!
